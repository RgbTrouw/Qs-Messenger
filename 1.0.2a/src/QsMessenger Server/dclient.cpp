...
dclient::dclient(QHostAddress ip_address, quint16 remote_port, QString session_id_code, int clients_id)
{
...
void dclient::process_text_message(QString message){
...
void dclient::process_binary_message(QByteArray data){
...
void dclient::socket_disconnected(){
...
void dclient::receiveMessage(QString senderEmail, QString receiverEmail, QString message, QString timeMseconds){
...
void dclient::getOfflineMessages(){
...
void dclient::getOfflineFriendRequests(){
...
void dclient::receiveFriendRequest(QString peerEmail, QString myEmail)
{
...
void dclient::receiveStatusUpdate(QString peerEmail){
