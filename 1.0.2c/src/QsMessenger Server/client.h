...
public slots:
    ...
    void receiveFileRequest(QString senderEmail, QString receiverEmail, QString fileName, QString fileSize);
    void receiveFileResponse(QString senderEmail, QString receiverEmail, QString fileName, QString response);
...
signals:
    ...
    void emit_sendFileRequest(QString myEmail, QString peerEmail, QString fileName, QString fileSize);
    void emit_sendFileResponse(QString myEmail, QString peerEmail, QString fileName, QString response);
