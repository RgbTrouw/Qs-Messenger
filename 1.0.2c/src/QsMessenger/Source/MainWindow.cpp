...
void MainWindow::onTextMessageReceived(QString message)
{
    ...
    if (message == "Email already in use or not activated..." || message == "Registration success... Please activate your account..." || message == "Activation success..." || message == "Activation failed..."){
...
void MainWindow::showHideMainWindow() { if (this->isVisible()){ this->hide(); showHideAction->setText("Show"); } else if (!this->isVisible()){ int x=1642; int y=42; this->setGeometry(x,y,280,900); this->show(); showHideAction->setText("Hide"); } }
