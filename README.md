...
After login, the proeminent element of the program is the FriendsList Object / Widget. It consists of "group" objects (+group "header") and subsequent "peer" objects, enclosed as QList<> type variable.
