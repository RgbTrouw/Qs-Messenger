...
The Gmail smtp service works well. Note that the password used is an "app password" and it is different from the regular account password. This one is generated by Gmail in the account settings.  
