...
* sessionId was supposed to be implemented in early stages, is still present in all queries, but doesn't provide any particular purpose, except for being a log indicator.
