...
** Update  ** It is indeed connecting with qt 6 on Windows. However, the Mysql driver is missing / not loading the database. I suspect that we will fix it and there will be a Windows binary available soon.  
