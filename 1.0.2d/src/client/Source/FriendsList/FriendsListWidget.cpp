/*   Q-s Messenger Client v 1.0.2d Instant Messaging Application
...
void FriendsListWidget::set_data(QString plain_data){
    ...
    for (int i = 0; i< groups.size(); i++){ui->verticalLayout->removeWidget(groups.at(i));
    ...
    nr_of_groups = plain_groups.size();
