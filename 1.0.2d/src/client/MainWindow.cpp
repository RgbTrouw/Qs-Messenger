    ...
    ui(new Ui::MainWindow)
{
    ...
    trayIcon->setIcon(QIcon("./Resources/offline.png"));
    ...
    ui->availabilityDropDownMenu->setItemIcon(0,QIcon("./Resources/icons/connected.png"));
    ui->availabilityDropDownMenu->setItemIcon(1,QIcon("./Resources/icons/busy.png"));
    ui->availabilityDropDownMenu->setItemIcon(2,QIcon("./Resources/icons/offline.png"));
...
void MainWindow::onDisconnected(){
    ...
    trayIcon->setIcon(QIcon("./Resources/icons/offline.png")); /// smiley_offline
    signOut();
       ...
       // ui->menuMessenger->removeAction(hostnameAction);
        ...
        QTimer::singleShot(1000, this, [=](){
            if(ui->availabilityDropDownMenu->currentIndex() != 2){
                trayIcon->setIcon(QIcon("./Resources/icons/connected.png"));
            } else {
                trayIcon->setIcon(QIcon("./Resources/icons/offline.png")); // smiley_offline
            }
...
\
    ...
    if (QRegularExpression(QRegularExpression::wildcardToRegularExpression(searchPattern)).match(message).hasMatch()){
        ...
        ui->availabilityDropDownMenu->setCurrentIndex(0);
...
void MainWindow::autologin(){ QTimer::singleShot(3200, this, SLOT(signIn()));}
...
//    else if(index == 5){index = 2;}
    ...
    if (ui->availabilityDropDownMenu->currentIndex() == 2){
        ...
        trayIcon->setIcon(QIcon("./Resources/icons/busy.png")); /// smiley_busy
    }
...
//                                         if(ui->availabilityDropDownMenu->currentIndex() == 1 && ui->statusMessageLineEdit->text().length() < 1 && !busyOnce ){
//                                             statusMessage = "Busy";
//                                             busyOnce = true;
//                                         } else if(ui->availabilityDropDownMenu->currentIndex() == 1 && ui->statusMessageLineEdit->text().length() < 1 && busyOnce ){
//                                             statusMessage = "";
//                                             busyOnce = false;

//                                         } else {
                                            statusMessage = ui->statusMessageLineEdit->text();
                                            //busyOnce = false;
